...
from .forms import SignUpForm, CheckoutForm, CouponForm, Shipping, RefundForm, PaymentForm
from django.utils import timezone
from .models import Item, Order, OrderItem, Address, UserProfile, Refund, Coupon, Payment
import stripe
import string
import random
...
class SearchView(ListView):
        ...
        def get_queryset(self):
            try:
                return Item.objects.filter(Q(title_icontain='Bag'))
            except:
...
class OrderSummaryView(LoginRequiredMixin, View):
    ...
    def post(self, *args, **kwargs):
       ...
       # order.ordered = False
       # order.options = shipping_option
       # order.get_total_coupon =+ shipping_cost
       # order.save()
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            amount = int(order.get_total_coupon() * 100)
